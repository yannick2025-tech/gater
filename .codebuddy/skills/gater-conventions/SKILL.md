...
```
feat(codec): add BCD encoding support for temperature values
fix(web): prevent end time reset on manual input in price table
refactor(protocol): extract message parsing into separate handler
docs: add basic encoding/decoding guide
